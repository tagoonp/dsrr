			...
			<div class="col-12">
				<div class="section-title">
					...
					<div class="content pe-0 pe-lg-12">
						...
						<div class="rounded shadow bg-white tab-content mt-5 p-0" id="pills-tabContent">
							<div class="content pe-0 pe-lg-12 p-0" id="googleMap" style="height: 500px; width: 100%; background: #ccc;">
							</div>
						</div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo MAP_API_KEY; ?>&callback=initMap&v=weekly" defer ></script>
...
<script>
      ...
      function initMap() {
        var mapProp= {
          center: new google.maps.LatLng(7.007046881931728, 100.49663547140167),
          zoom:15,
        };
        ...
        var posi = {
		lat: 7.007046881931728,
		lng: 100.49663547140167,
		};
