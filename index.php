...
<head>
	...
	<link rel="shortcut icon" href="template/front/images/favicon.png" type="image/x-icon">
	<link rel="icon" href="template/front/images/favicon.png" type="image/x-icon">
  ...
  <meta name="theme-name" content="wallet" />
	...
	<link rel="stylesheet" href="template/front/plugins/font-awesome/fontawesome.min.css">
	<link rel="stylesheet" href="template/front/plugins/font-awesome/brands.css">
	<link rel="stylesheet" href="template/front/plugins/font-awesome/solid.css">
    ...
    <div class="row align-items-center">
      <div class="col-lg-5">
        <div class="section-title">
          ...
          </p> <a class="btn btn-primary mt-4" href="about">Know About Us</a>
        </div>
      </div>
        ...
        <div class="rounded shadow bg-white p-5 tab-content" id="pills-tabContent">
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                <div class="image-block text-center">
                  <img loading="lazy" decoding="async"
                    src="template/front/images/payment-info.png" alt="How Much Can I Recive?" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
          <div class="tab-pane fade " id="pills-how-much-does-it-costs" role="tabpanel"
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                <div class="image-block text-center">
                  <img loading="lazy" decoding="async" src="template/front/images/illustration-2.png" alt="How Much Does It Costs?" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
          <div class="tab-pane fade " id="pills-how-do-i-repay" role="tabpanel"
            ...
            <div class="row align-items-center">
              ...
              <div class="col-md-6 order-0 order-md-1 mb-5 mt-md-0">
                <div class="image-block text-center">
                  <img loading="lazy" decoding="async" src="template/front/images/illustration-1.png" alt="How Do I Repay?" class="img-fluid">
                </div>
              </div>
            </div>
          </div>
    ...
    <div class="row position-relative">
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="template/front/images/testimonials/01.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="template/front/images/testimonials/02.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="template/front/images/testimonials/03.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="template/front/images/testimonials/04.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="template/front/images/testimonials/05.jpg"
      ...
      <div class="col-lg-4 col-md-6 pt-1">
        <div class="shadow rounded bg-white p-4 mt-4">
          <div class="d-block d-sm-flex align-items-center mb-3">
            <img loading="lazy" decoding="async"
              src="template/front/images/testimonials/06.jpg"
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					...
					<ul class="list-unstyled">
						<li class="mb-2"><a href="service-details">Personal loans</a>
						</li>
						<li class="mb-2"><a href="service-details">Home Equity Loans</a>
						</li>
						<li class="mb-2"><a href="service-details">Student Loans</a>
						</li>
						<li class="mb-2"><a href="service-details">Mortgage Loans</a>
						</li>
						<li class="mb-2"><a href="service-details">Payday Loans</a>
						</li>
					</ul>
				</div>
			</div>
