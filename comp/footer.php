<footer class="section-sm bg-tertiary">
	<div class="container">
		<div class="row justify-content-between">
			...
			<div class="col-lg-2 col-md-4 col-6 mb-4">
				<div class="footer-widget">
					<h5 class="mb-4 text-primary">ช่วยเหลือ</h5>
					<ul class="list-unstyled">
						<li class="mb-2"><a href="contact">ติดต่อเรา</a>
						</li>
						<li class="mb-2"><a href="faq">คำถามที่พบบ่อย</a>
						</li>
					</ul>
				</div>
			</div>
			<div class="col-lg-4 col-md-12 newsletter-form">
				<div style="background-color: #F4F4F4; padding: 35px;">
					<h5 class="mb-4 text-primary fw-500">รับข่าวสาร</h5>
					...
					<p class="mb-0">กรอกอีเมลแอดเดรสของท่านเพื่อรับข่าวสาร หรือกดปุ่ม Social network ด้านล่างเพื่อติดตาม</p>
				</div>
			</div>
		</div>
